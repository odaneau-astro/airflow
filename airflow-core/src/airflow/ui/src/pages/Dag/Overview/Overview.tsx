  ...
  return (
    <Box m={4} spaceY={4}>
      ...
      <HStack flexWrap="wrap">
        <TrendCountButton
          colorPalette={(failedTasks?.total_entries ?? 0) === 0 ? "taskState.success" : "taskState.failed"}
        ...
        />
        <TrendCountButton
          colorPalette={(failedRuns?.total_entries ?? 0) === 0 ? "taskState.success" : "taskState.failed"}
