    ...
    <VStack gap={6} p={6} align="start">
      ...
      <Box>
        ...
        <HStack gap={3} wrap="wrap">
          ...
          <Button colorPalette="purple" variant="solid" size="lg">Purple Large</Button>
      ...
      <Box>
        ...
        <HStack gap={3} wrap="wrap">
          ...
          <Badge colorPalette="purple" variant="solid" size="md">Purple Medium</Badge>
        </HStack>
      </Box>
      ...
      <Box>
        ...
        <HStack gap={3} wrap="wrap">
          ...
          <Badge colorPalette="blue" variant="solid">Running</Badge>
      ...
      <Box>
        ...
        <HStack gap={3} wrap="wrap">
          ...
          <StatsCardExample colorPalette="blue" count={3} label="Running DAGs" />
...
const StatsCardExample = ({ 
  ...
  >
    <HStack>
      ...
      <Text fontSize="sm" fontWeight="bold" color="colorPalette.700" _dark={{ color: "colorPalette.200" }}>
        {label}
      </Text>
    </HStack>
  </Box>
